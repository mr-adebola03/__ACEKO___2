...
const AddNewAntecedent = () => {
    ...
    return (
        <Content>
            <div>
                <Link to="/docteur/patient-donne-medical/antecedants" className='flex justify-between items-center mb-4'><IoIosArrowRoundBack className='text-3xl cursor-pointer' /> <p className='w-[60%] text-xl text-slate-500 font-medium'>Add New Antécédent</p></Link>
                <div className='w-[90%] p-4 bg-slate-100 rounded-md shadow-md mx-auto mb-4'>
                    <h2 className='font-bold text-gray-700 text-2xl text-center mb-4'>Add New Antécédent</h2>
...
function DateInput({ date, onDateChange, error }) {
    return (
        <div className="mb-2">
            <label htmlFor="dateNaissance" className="form-label">Date </label>
...
export default AddNewAntecedent