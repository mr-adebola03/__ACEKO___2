...
const PatientConsultation = () => {
  return (
    <Content>
       <div className=''>
            <Link to="/docteur/patient-historique-consultation"><IoIosArrowRoundBack className='text-3xl cursor-pointer mb-2' /></Link>
            <div className='mb-4 px-2'><Title>Consultation Patient</Title></div>
            <div className='flex'>
                <div className='bg-slate-100 shadow-lg rounded-lg py-4 h-fit w-[70%] px-6 mr-2'>
                    <h3 className='text-center mb-2'>Consulation n°1</h3>
                    <div className='mb-3 border-b border-solid border-slate-400 p-3'>
                        ...
                        <div className='flex justify-between items-center mb-2'>
                            <h3>Motif</h3>
                            <p>Anormalie dans vos resultats</p>
                        </div>
                    </div>
                    <div className=' border-b border-solid border-slate-400 py-2 px-4'>
                        <h3 className='text-lg font-semibold mb-2 text-center'>Les analyses</h3>
